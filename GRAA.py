...
class MainLoop():
        ...
        def __init__(self):
            ...
            print ('\n                            FOR DARK ARMY ONLY!                     \n')
            print ('                 01010o.....::DARK ARMY DDOS::.....o01010\n')
            print ('                               FOUNDER: PH.HunterX \\')
            print ('\n\t                        CO-FOUNDER: PH.M4X                          \n')
            print ('\t                PROJECT BY PH.11a14e11i && PH.S4CH1             \n\n')  
        ...
        def setup(self):
            while True:                    
                try:
                    ...
                    print ('> NUYAN D KO MAOPEN UNG URL NA SINASABI MO.')
            while True:            
                    try:
                        l = str(input('> LAGAY MO DITO UNG PATH NG PROXY LIST: '))
                        in_file = open(l,"r")
                        lista = []
                        for i in in_file:
            ...
            while True:
                try:
                    num_process = int(input('> LAGAY MO DITO KUNG ILANG PROCESS NA NUMERO[6]: '))
                except:
                    num_process = 6
                break
            print ("ETO NA GRAA GRAAA POW POW >>> 100 thread * %s process = %s"%(num_process, 200*num_process))
            time.sleep(2)
